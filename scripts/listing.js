...
function gMap() {
  ...
  $.getScript("https://maps.googleapis.com/maps/api/js?key=" + listingMapMeta.apiKey, function () {
    var map = new google.maps.Map(document.getElementById("listing-google-map"), {
      zoom: 12,
      scrollwheel: false,
