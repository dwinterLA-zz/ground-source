...
var VALID_MAILER_KEYS = ["name", "email", "phone"];
var GOOGLE_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbzfbEoLceZY6ZVXRjwOJU5J_iu4gW15y9vSSLuwXjGEk0w7ojg/exec";
...
function handleFormSubmit(event) {
  ...
  if (!validEmail(data.email)) {
    ...
    var encoded = Object.keys(data).reduce(function (encodedData, currentKey) {
      if (VALID_MAILER_KEYS.includes(currentKey)) {
        encodedData.push(encodeURIComponent(currentKey) + "=" + encodeURIComponent(data[currentKey]));
      }
